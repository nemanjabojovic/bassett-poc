...
const StaticFramesBaseTypeMenuCard = ({
  baseTypes,
  itemClicked,
  setItemClicked,
  isLeftSidebar,
  ...
  const handleBaseTypeClick = async (baseType, event, selectedOption) => {
    ...
    await window.player.setBaseType(baseType, true);
  };
  ...
  return (
    ...
    >
      ...
      >
        {baseTypes && baseTypes.map((baseType, index) => (
          <div
            key={index}
...
export default StaticFramesBaseTypeMenuCard;
